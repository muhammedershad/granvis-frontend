...
import { ShieldCheck, Users, FileText, Settings, UserPlus, TrendingUp } from "lucide-react";
                    ...
                    <CardContent className="space-y-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-xs text-muted-foreground">John Doe joined Development team</p>
                            </div>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-xs text-muted-foreground">Sarah Smith promoted to Manager</p>
                            </div>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-xs text-muted-foreground">Marketing department initialized</p>
                            </div>
