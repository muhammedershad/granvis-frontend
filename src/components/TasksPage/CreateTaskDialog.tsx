...
import { CreateTaskFormValues, createTaskSchema } from "@/lib/validations/task";
import { FileUploadArea, SelectedFile } from "./FileUploadArea";
...
interface CreateTaskDialogProps {
  ...
  onSubmit: (data: CreateTaskFormValues, attachments: TaskAttachment[]) => void;
