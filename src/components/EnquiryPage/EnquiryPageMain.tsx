...
const mockEnquiries: Enquiry[] = [
  {
    ...
    projectDetails:
      "Looking for a modern office complex design with sustainable features. Approximately 50,000 sq ft.",
    customFields: {
    ...
    notes: [
      "Initial contact through website form",
  ...
  },
  {
    ...
    projectDetails:
      "Residential villa project with modern architectural style. Looking for a luxury design with smart home integration.",
    customFields: {
        ...
        <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
          ...
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto bg-card/95 backdrop-blur-sm">
            ...
            <DialogHeader className="relative">
              ...
              <DialogDescription>
                Capture comprehensive client enquiry details and project
                requirements to build your pipeline
              </DialogDescription>
            </DialogHeader>
                ...
                <div className="space-y-4">
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <Label htmlFor="existing" className="text-foreground">
                        Existing Client
                      </Label>
                    </div>
                    <div className="flex items-center space-x-3">
                  ...
                  {formData.careOf.type === "existing" ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-3">
                        <Label htmlFor="careOfName" className="text-foreground">
                          Contact Name
                        </Label>
                        <Input
                          id="careOfName"
            ...
            <DialogFooter className="relative pt-6 border-t border-border/50">
              ...
              <Button
                ...
                disabled={
                  !formData.name || !formData.phone || !formData.projectDetails
                }
                className="bg-gradient-to-r from-blue-600 via-blue-600 to-purple-600 hover:from-blue-700 hover:via-blue-700 hover:to-purple-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 border-0"
              >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Track and manage all client enquiries
              </p>
            </div>
          </div>
        ...
        <CardContent className="relative p-0">
          <div className="space-y-4 p-6">
            {filteredEnquiries.map((enquiry) => (
              <Card
                key={enquiry.id}
                className="relative overflow-hidden bg-card/30 hover:bg-card/50 border-border/30 hover:border-border/60 transition-all duration-300 group hover:shadow-lg"
              >
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-start gap-3">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            <Badge
                              variant="outline"
                              className={`${getPriorityColor(enquiry.priority)} text-xs`}
                            >
                              {enquiry.priority.toUpperCase()}
                            </Badge>
                            <Badge
                              variant="outline"
                              className={`${getStatusColor(enquiry.status)} text-xs`}
                            >
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="text-sm">
                          {enquiry.careOf.type === "existing" ? (
                            ...
                            <span className="text-muted-foreground">
                              Care of: {enquiry.careOf.name} -{" "}
                              {enquiry.careOf.address}
                            </span>
                          )}
                        </div>
                        ...
                        {enquiry.status === "new" && (
                          <>
                            <Button
                              ...
                              variant="outline"
                              onClick={() =>
                                updateEnquiryStatus(enquiry.id, "follow-up")
                              }
                            ...
                            <Button
                              ...
                              variant="outline"
                              onClick={() =>
                                updateEnquiryStatus(enquiry.id, "converted")
                              }
                        ...
                        {enquiry.status === "follow-up" && (
                          <>
                            ...
                            <Button
                              ...
                              variant="outline"
                              onClick={() =>
                                updateEnquiryStatus(enquiry.id, "dead-lead")
                              }
            ...
            <div className="space-y-4">
              ...
              {Object.keys(selectedEnquiry.customFields).length > 0 && (
                <div>
                  <Label>Custom Fields</Label>
                  <div className="space-y-2">
                    {Object.entries(selectedEnquiry.customFields).map(
                      ([key, value]) => (
