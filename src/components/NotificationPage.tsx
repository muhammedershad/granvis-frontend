  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange}>
        <div className="overflow-x-auto no-scrollbar bg-muted/30 rounded-xl px-1 sticky top-0 z-10">
          <TabsList className="inline-flex w-max min-w-full p-1 bg-transparent gap-1">
            <TabsTrigger
              value="all"
