...
import { Shield, Users, Building2, Activity, TrendingUp, AlertCircle } from "lucide-react";
            ...
            <Card className="backdrop-blur-xl bg-white/70 dark:bg-black/20 border-white/20 dark:border-white/10 p-6 relative overflow-hidden shadow-xl dark:shadow-2xl shadow-gray-200/50 dark:shadow-black/50">
                ...
                <div className="relative flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-1">Complete system oversight and control</p>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 ">
                ...
                <Card className="backdrop-blur-xl bg-white/70 dark:bg-black/20 border-white/20 dark:border-white/10 p-6 relative overflow-hidden shadow-xl dark:shadow-2xl shadow-gray-200/50 dark:shadow-black/50">
                    ...
                    <div className="relative">
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                            <span className="text-green-600 dark:text-green-400">+3</span> new this month
                        </p>
                    </div>
                </Card>
                ...
                <Card className="backdrop-blur-xl bg-white/70 dark:bg-black/20 border-white/20 dark:border-white/10 p-6 relative overflow-hidden shadow-xl dark:shadow-2xl shadow-gray-200/50 dark:shadow-black/50">
                    ...
                    <div className="relative">
                        <div className="flex items-center justify-between ">
                            ...
                            <Badge variant="secondary" className="bg-red-100/80 dark:bg-red-500/20 text-red-700 dark:text-red-300 border-red-200 dark:border-red-500/30 shadow-lg shadow-red-100/50 dark:shadow-red-500/10">
                                3 Active
                            </Badge>
                        </div>
                            ...
                            <div className="p-3 rounded-lg bg-white/60 dark:bg-white/5 border border-white/40 dark:border-white/10 shadow-lg shadow-gray-100/50 dark:shadow-black/20 hover:shadow-xl hover:bg-white/80 dark:hover:bg-white/10 dark:hover:shadow-black/30 transition-all duration-300">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-sm font-medium text-foreground">Database backup pending</p>
                                        <p className="text-xs text-muted-foreground">Scheduled for 2:00 AM</p>
                                    </div>
                                </div>
                            </div>
