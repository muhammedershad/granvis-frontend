...
import { Building2, Handshake, IndianRupee, Shield, Users } from "lucide-react";
import { useGetSuperAdminDashboardQuery } from "@/lib/api/dashboardApi";
...
export const SuperAdminDashboard = () => {
  ...
  const { data, isLoading, isError, refetch } =
    useGetSuperAdminDashboardQuery(dateParams);
