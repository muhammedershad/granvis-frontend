    ...
    <Card className="backdrop-blur-xl bg-white/70 dark:bg-black/20 border-white/20 dark:border-white/10 p-6 relative overflow-hidden shadow-xl dark:shadow-2xl shadow-gray-200/50 dark:shadow-black/50">
      ...
      <div className="relative">
        <div className="flex items-center justify-between mb-6">
          ...
          <Badge
            variant="secondary"
            className="bg-blue-100/80 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-500/30 shadow-lg shadow-blue-100/50 dark:shadow-blue-500/10"
          >
            5 Members
          </Badge>
        </div>
        ...
        <div className="space-y-4">
          {teamMembers.map((member) => (
            <div
              key={member.id}
              className="flex items-center justify-between p-4 rounded-lg bg-white/60 dark:bg-white/5 border border-white/40 dark:border-white/10 shadow-lg shadow-gray-100/50 dark:shadow-black/20 hover:shadow-xl hover:bg-white/80 dark:hover:bg-white/10 dark:hover:shadow-black/30 transition-all duration-300 group"
            >
              ...
              <div className="flex items-center space-x-4">
                <Badge
                  variant="outline"
                  className="bg-white/40 dark:bg-white/5 text-muted-foreground border-white/40 dark:border-border shadow-sm"
                >
                  {member.specialty}
                </Badge>
