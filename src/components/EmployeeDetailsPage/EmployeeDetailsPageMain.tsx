  ...
  workHistory: [
    {
      ...
      description:
        "Lead technical architecture for core platform, mentoring team of 8 developers",
      achievements: [
...
export function EmployeeDetailsPage({
  ...
  useEffect(() => {
    ...
    console.warn("Loading employee details for ID:", employeeId);
  }, [employeeId]);

  const handleSave = () => {
    setEmployee(editedEmployee);
    setIsEditing(false);
    console.warn("Employee updated:", editedEmployee);
  };
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-white/60">
            Comprehensive employee profile and management
          </p>
        </div>
                ...
                <CardContent>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60 text-sm">
                        {employee.managerDetails.position}
                      </p>
                      <p className="text-white/60 text-sm">
                        {employee.managerDetails.email}
                      </p>
                    </div>
                  </div>
                </CardContent>
        ...
        <TabsContent value="performance" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {employee.performance.map((metric) => (
              <Card
                key={metric.id}
                className="bg-black/20 border-white/10 backdrop-blur-xl"
              >
