...
export function CRMPage() {
  ...
  const handleAttendanceAction = (action: AttendanceActionType) => {
    ...
    switch (action) {
      case "clock-in":
        setIsClockedIn(true);
        console.warn(`Clocked in at ${timeString} from ${locationInfo}`);
        break;
      case "clock-out":
        setIsClockedIn(false);
        setIsOnBreak(false);
        console.warn(`Clocked out at ${timeString} from ${locationInfo}`);
        break;
      case "break-start":
        setIsOnBreak(true);
        console.warn(`Break started at ${timeString}`);
        break;
      case "break-end":
        setIsOnBreak(false);
        console.warn(`Break ended at ${timeString}`);
        break;
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
        ...
        <div className="flex items-center space-x-2">
          <div className="text-right">
            <p className="text-xl font-semibold bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 dark:from-white dark:via-gray-100 dark:to-white bg-clip-text text-transparent">
      ...
      >
        ...
        <div
          className="absolute bottom-4 left-4 w-16 h-16 bg-gradient-to-br from-indigo-100/40 to-cyan-100/20 dark:from-cyan-500/10 dark:to-blue-500/5 rounded-full blur-xl animate-pulse"
        ...
        <CardContent className="relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                <div
                  className={`w-3 h-3 rounded-full ${isClockedIn ? "bg-green-400" : "bg-red-400"} animate-pulse`}
                ></div>
              ...
              <Button
                onClick={() =>
                  handleAttendanceAction(isClockedIn ? "clock-out" : "clock-in")
                }
                className={`w-full ${
                  isClockedIn
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto bg-white/95 dark:bg-black/90 border border-gray-200/60 dark:border-white/10 backdrop-blur-xl">
                  <DialogHeader>
                    <DialogTitle className="text-gray-900 dark:text-white/90">
                      Apply for Leave
                    </DialogTitle>
            ...
            >
              ...
              <div className="relative flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-semibold bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 dark:from-white dark:via-gray-100 dark:to-white bg-clip-text text-transparent">
            ...
            {leaveBalances.map((balance) => (
              ...
              >
                ...
                <div className="relative space-y-3">
                  <div className="flex items-center justify-between">
                    <h3 className="font-semibold bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 dark:from-white dark:via-gray-100 dark:to-white bg-clip-text text-transparent">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="text-gray-900 dark:text-white/80 font-semibold">
                        {balance.used}/{balance.totalAllowed}
                      </span>
                    </div>
                    <Progress
                ...
                <div className="flex items-center space-x-2">
                  ...
                  >
                    <DialogTrigger asChild>
                      <Button
                        size="sm"
                        className="bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 border-0 text-white shadow-lg hover:shadow-xl transition-all duration-200"
                      >
                        <Plus className="w-4 h-4 mr-2" />
                        Apply Leave
                      </Button>
                    ...
                    <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto bg-white/95 dark:bg-black/90 border border-gray-200/60 dark:border-white/10 backdrop-blur-xl">
                      <DialogHeader>
                        ...
                        <DialogDescription className="text-gray-600 dark:text-white/60">
                          Submit a new leave application with all required
                          details.
                        </DialogDescription>
                      </DialogHeader>
                      <LeaveApplicationForm
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="border-gray-200/60 dark:border-white/10 hover:bg-gray-50/50 dark:hover:bg-white/5">
                      <TableHead className="text-gray-700 dark:text-white/70 font-medium">
                        Leave Type
                      </TableHead>
                      <TableHead className="text-gray-700 dark:text-white/70 font-medium">
                        Dates
                  ...
                  <TableBody>
                    {leaveRequests.map((request) => (
                      <TableRow
                        key={request.id}
                        className="border-gray-200/60 dark:border-white/10 hover:bg-gray-50/50 dark:hover:bg-white/5 transition-colors duration-150"
                      >
                        <TableCell>
                          <div className="flex items-center space-x-2">
                            <div
                              className={`w-3 h-3 rounded-full ${request.leaveType.color}`}
                            ></div>
                        ...
                        <TableCell className="text-gray-800 dark:text-white/80 font-medium">
                          {request.totalDays}
                        </TableCell>
                        <TableCell className="text-gray-800 dark:text-white/80 max-w-40 truncate">
                          {request.reason}
                        </TableCell>
                        <TableCell>
                          <Badge
                            className={cn(
                              "capitalize",
                              getLeaveStatusColor(request.status)
                            )}
                          >
                            {request.status}
                          </Badge>
                          ...
                          <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                              <Button
                                variant="ghost"
                                size="icon"
                                className="text-gray-600 dark:text-white/70 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-white/10"
                              >
                                <MoreHorizontal className="w-4 h-4" />
                              </Button>
                            </DropdownMenuTrigger>
                            <DropdownMenuContent
                              align="end"
                              className="bg-white/95 dark:bg-gray-900/95 border border-gray-200/60 dark:border-white/10 backdrop-blur-xl"
                            >
