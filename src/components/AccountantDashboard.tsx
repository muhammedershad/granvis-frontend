...
import { Calculator, DollarSign, TrendingUp, CreditCard, Wallet, Receipt } from "lucide-react";
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1">Manage finances and transactions</p>
                </div>
                    ...
                    <CardContent className="space-y-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-xs text-muted-foreground">Client ABC - Invoice #1234</p>
                            </div>
                            <span className="text-sm font-semibold text-green-500">+$5,200</span>
                        </div>
                        <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1">
                                <p className="text-sm font-medium">Payment Received</p>
                                <p className="text-xs text-muted-foreground">Client XYZ - Invoice #1235</p>
                            </div>
                            <span className="text-sm font-semibold text-green-500">+$3,100</span>
                        </div>
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-full bg-red-500/10 flex items-center justify-center">
                            ...
                            <span className="text-sm font-semibold text-red-500">-$28,500</span>
                        </div>
                    </CardContent>
                </Card>
            </div>
