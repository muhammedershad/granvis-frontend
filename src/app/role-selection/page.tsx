...
import { IAuthRoles, setUser } from "@/store/slices/authSlice";
import {
  ArrowRight,
  Calculator,
  ShieldAlert,
      ...
      <div className="max-w-5xl w-full space-y-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Welcome to Griha. Please select your role to access your dedicated
            dashboard.
          </p>
        </div>
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full justify-between space-y-4">
                  <div className="space-y-4">
                    <div
                      className={`w-12 h-12 rounded-xl ${role.bg} flex items-center justify-center`}
                    >
